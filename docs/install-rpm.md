...
directly:
    ...
    # dnf install https://github.com/ubccr/xdmod/releases/download/v{{ page.rpm_version }}/xdmod-{{ page.rpm_version }}.el8.x86_64.rpm
...
page.rpm_version }}) and install it:
    ...
    # dnf install xdmod-{{ page.rpm_version }}.el8.x86_64.rpm
