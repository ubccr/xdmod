...
class SessionsCountStatistic extends \DataWarehouse\Query\Cloud\Statistic
{
    ...
    {
        return 'The total number of sessions that were ended on a cloud resource. A session is ended when a VM is paused, shelved, stopped, or terminated on a cloud resource.<br/>
