...
class WeightedMemoryWallStatistic extends \DataWarehouse\Query\Cloud\Statistic
{
    ...
    {
        parent::__construct(
            'COALESCE(SUM(jf.memory_mb * (jf.wallduration/3600.0)) / SUM(jf.wallduration/3600.0),0)',
            'weighted_memory_mb',
    ...
    {
        return 'The total amount of memory (in megabytes) reserved by active VM instances, weighted by wall hours.<br/>
