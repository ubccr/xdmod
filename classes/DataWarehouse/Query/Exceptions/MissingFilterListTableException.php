...
class MissingFilterListTableException extends QueryException
{
     ...
     */
    public const defaultMessage = 'Filter data could not be found. If data has not been ingested and aggregated yet, this is to be expected. If Open XDMoD has been upgraded from a version before 5.6.0, please see the upgrade documentation.';

    /**
     * The code used by this exception if none is provided.
     */
    public const defaultCode = \XDError::QueryMissingFilterListTable;
