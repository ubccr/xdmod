...
abstract class GroupBy extends \Common\Identity
{
    ...
    */
    abstract public function applyTo(\DataWarehouse\Query\Query &$query, \DataWarehouse\Query\Model\Table $data_table);
	...
	*/
    ...
    public function getShortNameColumnName($multi = false)
    {
        if ($multi !== true) {
            ...
            return $this->getName().'_short_name';
        }
    }
