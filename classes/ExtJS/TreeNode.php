...
namespace ExtJS;
   ...
   class TreeNode {
      ...
      public function setAsLeaf($leafNode): void
      {
         $this->_tree_data['leaf'] = $leafNode;
      }
      ...
      public function setID($nodeID): void
      {         
      ...
      public function setText($nodeText): void
      {         
         $this->_tree_data['text'] = $nodeText;
      }
      ...
      public function addChildNode($childNode): void
      {         

         if (!isset($this->_tree_data['children'])){
            $this->_tree_data['children'] = [];
         }
