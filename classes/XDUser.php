...
SQL;
    ...
    public function getInsertQuery($updateToken = false, $includePassword = false)
    {
        ...
        if ($updateToken && $includePassword) {
            $result = 'INSERT INTO moddb.Users (username, password, email_address, first_name, middle_name, last_name, account_is_active, person_id, organization_id, field_of_science, token, user_type, sticky) VALUES (:username, :password, :email_address, :first_name, :middle_name, :last_name, :account_is_active, :person_id, :organization_id, :field_of_science, :token, :user_type, :sticky)';
        } else if (!$updateToken && $includePassword) {
            $result = 'INSERT INTO moddb.Users (username, password, email_address, first_name, middle_name, last_name, account_is_active, person_id, organization_id, field_of_science, user_type, sticky) VALUES (:username, :password, :email_address, :first_name, :middle_name, :last_name, :account_is_active, :person_id, :organization_id, :field_of_science, :user_type, :sticky)';
        } else if ($updateToken && !$includePassword) {
