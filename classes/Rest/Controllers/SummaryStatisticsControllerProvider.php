...
extends BaseControllerProvider
{
  ...
  public function getPastUsage(Request $request, Application $app)
  {
    ...
    case 'day':
      if ( $options['num_intervals'] > 365 ) $options['num_intervals'] = 365;
      break;
    case 'week':
      if ( $options['num_intervals'] > 52 ) $options['num_intervals'] = 52;
      break;
    case 'month':
      if ( $options['num_intervals'] > 60 ) $options['num_intervals'] = 60;
      break;
    case 'year':
      if ( $options['num_intervals'] > 5 ) $options['num_intervals'] = 5;
      break;
    }  // switch ( $options['interval'] )
