...
/**
 * The jQuery $.extend() API merges the content of subsequent objects into the
 * first one, overriding it’s original values. The method provided below returns
 * a new object instead, preserving all of the original objects and their
 * properties. Supported back to IE6.
        ...
        for (var prop in obj) {
            if (Object.prototype.hasOwnProperty.call(obj, prop)) {
                ...
                if (deep && Object.prototype.toString.call(obj[prop]) === '[object Object]') {
                    extended[prop] = XDMoD.utils.extend(true, extended[prop], obj[prop]);
                } else {
