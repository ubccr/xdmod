...
XDMoD.Module.JupyterHub = Ext.extend(XDMoD.PortalModule,  {

   title: 'JupyterHub',
   module_id: 'jupyterhub',
   usesToolbar: false,
   toolbarItems: {
   ...
   initComponent: function () {
      ...
      */
      ...
      XDMoD.Module.JupyterHub.superclass.initComponent.apply(this, arguments);

   },//initComponent

});//XDMoD.Module.JupyterHub
