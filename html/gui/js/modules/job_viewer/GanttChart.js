...
XDMoD.Module.JobViewer.GanttChart = Ext.extend(XDMoD.Module.JobViewer.ChartTab, {
    ...
    initComponent: function () {
        ...
        this.addListener('resize', function (panel, adjWidth, adjHeight, rawWidth, rawHeight) {
            if (this.chart) {
        ...
        this.addListener('updateChart', function (store) {
            ...
            layout['shapes'] = rect;
            this.chart = Plotly.newPlot(this.id, data, layout, {displayModeBar: false, doubleClick: 'reset'});        
