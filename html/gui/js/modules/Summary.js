...
Ext.extend(XDMoD.Module.Summary, XDMoD.PortalModule, {
  ...
  checkForUpdates: function() {
      if (CCR.xdmod.ui.metricExplorer && true === CCR.xdmod.ui.metricExplorer.summaryDirty) {
          ...
          tools: [

            {
              ...
              handler: function(event, toolEl, panel, tc) {
                  ...
                  XDMoD.Module.MetricExplorer.setConfig(config, config.summary_index, config.preset ? true : false);
