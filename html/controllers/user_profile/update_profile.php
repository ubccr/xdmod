<?php
   ...
   $user_to_update = \xd_security\getLoggedInUser();
    ...
    if (isset($_POST['email_address'])) {
        $user_to_update->setEmailAddress($_POST['email_address']);
    }
    
    if (isset($_POST['password'])) {
        $user_to_update->setPassword($_POST['password']);
    }
    if (isset($_POST['field_of_science'])) {
        $user_to_update->setFieldOfScience($_POST['field_of_science']);
    }
