...
try {
    ...
    ';
    [$last30DaysRow] = $pdo->query($sql);

    $returnData = ['success' => true, 'response' => [['user_count'             => $userCountRow['count'], 'logged_in_last_7_days'  => $last7DaysRow['count'], 'logged_in_last_30_days' => $last30DaysRow['count']]], 'count' => 1];
