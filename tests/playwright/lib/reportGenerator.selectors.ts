const selectors = {
    tab: () => `//div[contains(@class,'x-tab-panel-header')]//span[contains(@class, 'x-tab-strip-text') and text()='Report Generator']`,
    panel: () => '//div[@id="report_generator"]',
    mask: () => `//div[contains(@class, 'ext-el-mask')]`,
    configureTime: {
    ...
    myReports: {
        panel: () => selectors.panel() + `//div[contains(@class, 'report_overview')]`,
        toolbar: {
            panel: () => selectors.myReports.panel() + `//div[contains(@class, 'x-panel-tbar')]`,
            selectButton: () => selectors.myReports.toolbar.panel() + '//button[text()="Select"]',
            selectMenu: () => `//div[contains(@class, 'x-menu-floating') and contains(@style, "visibility: visible")]`,
            ...
            newBasedOnVisibleButton: () => selectors.myReports.toolbar.newBasedOnButton() + `/ancestor::table[contains(@class, 'x-btn')]`,
            numNewBasedOnVisibleButton: (num) => '(' + selectors.myReports.toolbar.newBasedOnVisibleButton() + ')[' + num + ']',
            newBasedOnMenu: () => `//div[contains(@class, 'x-menu-floating') and .//img[contains(@class, 'btn_selected_report') or contains(@class, 'btn_report_template')]]`,
            newBasedOnRows: () => selectors.myReports.toolbar.newBasedOnMenu() + `//li[not(contains(@class, 'x-menu-sep-li'))]`,
            newBasedOnTemplateRows: () => selectors.myReports.toolbar.newBasedOnMenu() + `//li[.//img[contains(@class, 'btn_report_template')]]`,
            newBasedOnTemplateRowsButton: () => selectors.myReports.toolbar.newBasedOnTemplateRows() + `//a[./img[contains(@class, 'btn_report_template')]]//b`,
            newBasedOnReportRows: () => selectors.myReports.toolbar.newBasedOnMenu() + `//li[.//img[contains(@class, 'btn_selected_report')]]`,
            newBasedOnTemplate: name => selectors.myReports.toolbar.newBasedOnTemplateRows() + `//a[.//b[text()="${name}"]]`,
            newBasedOnTemplateWithCenter: center => `//div[contains(@class, 'x-menu-floating')]//a[.//img[contains(@class, 'btn_resource_provider')] and .//span[contains(text(), "${center}")]]`,
            ...
            editButtonInClass: () => selectors.myReports.toolbar.editButton() + `/ancestor::table[contains(@class, 'x-btn')]`,
            previewButton: () => selectors.myReports.toolbar.panel() + '//button[text()="Preview"]',
            previewButtonInClass: () => selectors.myReports.toolbar.previewButton() + `/ancestor::table[contains(@class, 'x-btn')]`,
            sendNowButton: () => selectors.myReports.toolbar.panel() + '//button[text()="Send Now"]',
            sendNowButtonInClass: () => selectors.myReports.toolbar.sendNowButton() + `/ancestor::table[contains(@class, 'x-btn')]`,
            firstSendNowButton: () => '(' + selectors.myReports.toolbar.sendNowButton() + `/ancestor::table[contains(@class, 'x-btn')]` + ')[1]',
            sendNowAsPdfButton: () => `//div[contains(@class, 'x-menu-floating')]//span[text()="As PDF"]/ancestor::a`,
            sendNowAsWordDocumentButton: () => `//div[contains(@class, 'x-menu-floating')]//span[text()="As Word Document"]/ancestor::a`,
            downloadButton: () => selectors.myReports.toolbar.panel() + '//button[text()="Download"]',
            downloadButtonInClass: () => selectors.myReports.toolbar.downloadButton() + `/ancestor::table[contains(@class, 'x-btn')]`,
            firstDownloadButton: () => '(' + selectors.myReports.toolbar.downloadButton() + `/ancestor::table[contains(@class, 'x-btn')]` + ')[1]',
            downloadAsPdfButton: () => `//div[contains(@class, 'x-menu-floating')]//span[text()="As PDF"]/ancestor::a`,
            downloadAsWordDocumentButton: () => `//div[contains(@class, 'x-menu-floating')]//span[text()="As Word Document"]/ancestor::a`,
            deleteButton: () => selectors.myReports.toolbar.panel() + '//button[text()="Delete"]',
            deleteButtonInClass: () => selectors.myReports.toolbar.deleteButton() + `/ancestor::table[contains(@class, 'x-btn')]`
        },
        reportList: {
            panel: () => selectors.myReports.panel() + `//div[contains(@class, 'x-panel-body-noheader')]`,
            rows: () => selectors.myReports.reportList.panel() + `//div[contains(@class, 'x-grid3-row')]`,
            rowByIndex: index => selectors.myReports.reportList.panel() + `//div[contains(@class, 'x-grid3-row') and position()=${index}]`
        }
    },
    reportPreview: {
        panel: () => selectors.panel() + `//div[contains(@class, 'report_preview')]`,
        toolbar: {
            panel: () => selectors.reportPreview.panel() + `//div[contains(@class, 'x-panel-tbar')]`,
            ...
            returnToReportsOverviewButton: () => selectors.reportPreview.toolbar.panel() + `//button[contains(@class, 'btn_return_to_previous')]`
        }
    },
    reportEditor: {
        panel: () => selectors.panel() + `//div[contains(@class, 'report_edit')]`,
        toolbar: {
            panel: () => selectors.reportEditor.panel() + `//div[contains(@class, 'x-panel-tbar') and .//button[text()="Save"]]`,
            ...
            returnToMyReportsButton: () => selectors.reportEditor.toolbar.panel() + `//button[contains(@class, 'btn_return_to_overview')]`
        },
        generalInformation: {
            panel: () => selectors.reportEditor.panel() + `//div[contains(@class, 'x-panel') and .//span[text()="General Information"]]`,
        ...
        chartLayout: {
            panel: () => selectors.reportEditor.panel() + `//div[contains(@class, 'x-panel') and .//span[text()="Chart Layout"]]`,
        ...
        scheduling: {
            panel: () => selectors.reportEditor.panel() + `//div[contains(@class, 'x-panel') and .//span[text()="Scheduling"]]`,
            scheduleInput: () => selectors.reportEditor.scheduling.panel() + '//input[@name="report_generator_report_schedule"]',
            scheduleOption: name => `//div[contains(@class, 'x-combo-list-item') and text()="${name}"]`,
            deliveryFormatInput: () => selectors.reportEditor.scheduling.panel() + '//div[./label[text()="Delivery Format:"]]//input',
            deliveryFormatOption: name => `//div[contains(@class, 'x-combo-list-item') and text()="${name}"]`
        },
        includedCharts: {
            panel: () => selectors.reportEditor.panel() + '//div[@id="ReportCreatorGrid"]',
            toolbar: {
                panel: () => selectors.reportEditor.includedCharts.panel() + `//div[contains(@class, 'x-panel-tbar')]`,
                selectButton: () => selectors.reportEditor.includedCharts.toolbar.panel() + '//button[text()="Select"]',
                selectAllChartsButton: () => `//div[contains(@class, 'x-menu-floating')]//span[text()="All Charts"]/ancestor::a`,
                selectNoChartsButton: () => `//div[contains(@class, 'x-menu-floating')]//span[text()="No Charts"]/ancestor::a`,
                invertSelectionButton: () => `//div[contains(@class, 'x-menu-floating')]//span[text()="Invert Selection"]/ancestor::a`,
            ...
            chartList: {
                ...
                rows: () => selectors.reportEditor.includedCharts.chartList.panel() + `//div[contains(@class, 'x-grid3-row')]`
            }
        }
    },
    availableCharts: {
        ...
        toolbar: {
            ...
            selectAllChartsButton: () => `//div[contains(@class, 'x-menu-floating')]//span[text()="All Charts"]/ancestor::a`,
            selectNoChartsButton: () => `//div[contains(@class, 'x-menu-floating')]//span[text()="No Charts"]/ancestor::a`,
            invertSelectionButton: () => `//div[contains(@class, 'x-menu-floating')]//a[.//span[text()="Invert Selection"]]`,
        ...
        chartList: {
            ...
            rows: () => selectors.availableCharts.chartList.panel() + `//div[contains(@class, 'x-grid3-row')]`
        }
    },
    message: {
        window: () => '//div[@id="report_generator_message"]',
        titleElement: () => selectors.message.window() + `//span[contains(@class, 'x-window-header-text')]`,
        textElement: () => selectors.message.window() + '//b'
    },
    deleteSelectedReports: {
        window: () => `//div[contains(@class, 'x-window') and .//span[text()="Delete Selected Report" or text()="Delete Selected Reports"]]`,
    ...
    unsavedChanges: {
        window: () => `//div[contains(@class, 'x-window') and .//span[text()="Unsaved Changes"]]`,
    ...
    deleteSelectedCharts: {
        window: () => `//div[contains(@class, 'x-window') and .//span[text()="Delete Selected Chart" or text()="Delete Selected Charts"]]`,
    ...
    removeSelectedCharts: {
        window: () => `//div[contains(@class, 'x-window') and .//span[text()="Remove Selected Chart" or text()="Remove Selected Charts"]]`,
    ...
    saveReportAs: {
        window: () => `//div[contains(@class, 'x-window') and .//span[text()="Save Report As"]]`,
        ...
        reportNameInputInvalid: () => selectors.saveReportAs.window() + `//input[@name="report_name" and contains(@class, 'x-form-invalid')]`
    },
    reportBuilt: {
        window: () => `//div[contains(@class, 'x-window') and .//span[text()="Report Built"]]`,
        viewReportButton: () => selectors.reportBuilt.window() + '//button[text()="View Report"]',
        closeButton: () => selectors.reportBuilt.window() + `//div[contains(@class, 'x-tool-close')]`
    },
    editChartTimeframe: {
        window: () => `//div[contains(@class, 'chart_date_editor')]`,
        ...
        periodicOption: name => `//div[contains(@class, 'x-menu-floating')]//a[starts-with(text(),"${name}')]`,
        ...
        updateButton: () => selectors.editChartTimeframe.window() + `//button[contains(@class, 'chart_date_editor_update_button')]`,
        cancelButton: () => selectors.editChartTimeframe.window() + `//button[contains(@class, 'chart_date_editor_cancel_button')]`,
        errorMessage: () => selectors.editChartTimeframe.window() + `//div[contains(@class, 'overlay_message')]`
    },
    // The mask with the check mark image that is displayed after a report is ready for download or has been emailed.
    checkmarkMask: () => `//div[contains(@class, 'ext-el-mask-msg') and .//img[@src="gui/images/checkmark.png"]]`,
