...
class FilterExpressionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCacheVar($input, $isValid) {
        $this->runFilter(RESTRICTION_CHART_CACHEREF, $input, $isValid);
    }
    ...
    public function testReportIdVar($input, $isValid) {
        $this->runFilter(RESTRICTION_REPORT_ID, $input, $isValid);
    }
    ...
    public function testChartRefVar($input, $isValid) {
        $this->runFilter(RESTRICTION_REPORT_CHART_REF, $input, $isValid);
    }
    ...
    public function testReportTmpVar($input, $isValid) {
        $this->runFilter(RESTRICTION_REPORT_TMPDIR, $input, $isValid);
    }
}
