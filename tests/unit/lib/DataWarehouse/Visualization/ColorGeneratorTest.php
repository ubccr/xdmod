...
class ColorGeneratorTest extends \PHPUnit\Framework\TestCase
{
    public function setUp(): void
    {
        ...
        $this->inputdata = [["name" => "data1", "short_name" => "d1", "value" => "7"], ["name" => "data2", "short_name" => "d2", "value" => "2"], ["name" => "data3", "short_name" => "d3", "value" => "7"], ["name" => "data4", "short_name" => "d4", "value" => "5"]];
    }

    public function tearDown(): void {
    }

    public function testRoundRobinMapping(): void
    {
    ...
    public function testFixedMapping(): void
    {
    ...
    public function testFixedShortMapping(): void
    {
