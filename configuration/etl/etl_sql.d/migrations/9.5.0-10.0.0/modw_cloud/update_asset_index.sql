...
CREATE INDEX host_resource_idx ON modw_cloud.event_asset (asset_id, resource_id);
CREATE INDEX host_resource_idx ON modw_cloud.asset (asset_id, resource_id);
...
DROP INDEX host_resource_idx ON modw_cloud.asset;
DROP INDEX host_resource_idx ON modw_cloud.event_asset;
